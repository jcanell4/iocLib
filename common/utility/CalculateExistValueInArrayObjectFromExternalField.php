...
class CalculateExistValueInArrayObjectFromExternalField extends CalculateWithPersistenceAndValues{
    ...
    public function calculate($data) {
        ...
        if($externalValues){
            ...
            $ret = $this->existValueInArray($externalValues, $field, $fieldToSearch, $valueToSearch, $toReturn);
        }else{
