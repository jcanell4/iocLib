...
class Html2DWMarkup extends Html2DWInstruction {
    ...
    protected function getContent ($token) {
        ...
        // TODO: aquesta prova només fa el canvi per negreta, hem de considerar si fer un tipus especial per cada marca (bold, italic, etc.) o fer afegir més informació al token i fer servir la mateixa classe pels formats. Afegir un codi de sustitució?
        // per exemple: Codi de sustitició + value
        return '**' . $token['value'];
    }
    
    protected function resolveOnClose ($field) {
        // $field + codi de sustitució
        $ret = $field . '**';

        //$ret = 'TODO: resolveOnClose';
