...
//        "/\n/"
    ...
    protected static $tokenPatterns = [
        ...
        '<div class="ioc-quiz".*?(<\/table><\/div><\/div><\/div>|<\/pre><\/div><\/div>)' => [
            'state' => 'quiz'
        ],
...
//        ],
    ...
    protected static $tokenKey = [
        ...
        '<div class="ioc-quiz".*?(<\/table><\/div><\/div><\/div>|<\/pre><\/div><\/div>)' => ['state' => 'quiz', 'type' => 'quiz', 'class' => 'Html2DWQuiz', 'action' => 'self-contained', 'extra' => ['regex' => TRUE]],
