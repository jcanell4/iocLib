...
/*        '<div class="ioc-quiz".*?><\/table><\/div><\/div><\/div>' => ['state' => 'quiz', 'type' => 'quiz', 'class' => 'Html2DWQuiz', 'action' => 'self-contained', 'extra' => ['regex' => TRUE]],*/
        ...
        "<h1" => ['state' => 'open_h1', 'type' => 'h1', 'class' => 'Html2DWHeader', 'action' => 'open', 'extra' => ['replacement' => ['======', "======\n"], 'regex' => TRUE]],
        "<\/h1>\n?" => ['state' => 'close_h1', 'type' => 'h1', 'class' => 'Html2DWHeader', 'action' => 'close', 'extra' => ['regex' => TRUE]],
        "<h2" => ['state' => 'open_h2', 'type' => 'h2', 'class' => 'Html2DWHeader', 'action' => 'open', 'extra' => ['replacement' => ['=====', "=====\n"]]],
        "<\/h2>\n?" => ['state' => 'close_h2', 'type' => 'h2', 'class' => 'Html2DWHeader', 'action' => 'close', 'extra' => ['regex' => TRUE]],
        '<h3' => ['state' => 'open_h3', 'type' => 'h3', 'class' => 'Html2DWHeader', 'action' => 'open', 'extra' => ['replacement' => ['====', "====\n"]]],
        "<\/h3>\n?" => ['state' => 'close_h3', 'type' => 'h3', 'class' => 'Html2DWHeader', 'action' => 'close', 'extra' => ['regex' => TRUE]],
        "<h4" => ['state' => 'open_h4', 'type' => 'h4', 'class' => 'Html2DWHeader', 'action' => 'open', 'extra' => ['replacement' => ['===', "===\n"]]],
        "<\/h4>\n?" => ['state' => 'close_h4', 't   ype' => 'h4', 'class' => 'Html2DWHeader', 'action' => 'close', 'extra' => ['regex' => TRUE]],
        "<h5" => ['state' => 'open_h5', 'type' => 'h5', 'class' => 'Html2DWHeader', 'action' => 'open', 'extra' => ['replacement' => ['==', "==\n"]]],
        "<\/h5>\n?" => ['state' => 'close_h5', 'type' => 'h5', 'class' => 'Html2DWHeader', 'action' => 'close', 'extra' => ['regex' => TRUE]],
