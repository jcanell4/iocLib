...
class ProjectFactoryAuthorization extends AbstractFactoryAuthorization {
    ...
    public function setAuthorizationCfg() {
        ...
        $aCfg = ['cancelProject'                => "editProject"
                 ...
                 ,'duplicate_projectProject'    => "responsableProject"
                 ,'move_projectProject'         => "responsableProject"
                 ...
                 ,'revert_projectProject'       => "responsableProject"
                 ,'save_project_draftProject'   => "saveProject"
                ];
