<?php
/**
 * SendMessageAction: Envia una notificació i un missatge als destinataris
 * @culpable <rclaver@xtec.cat>
 */
if (!defined("DOKU_INC")) die();

class SendMessageAction extends NotifyAction {
    ...
    private function getProjectsList() {
        ...
        foreach ($listProjects as $project) {
            ...
            if ($root->getValue()) {
                $workflow = $this->model->isProjectTypeWorkflow($project['projectType']);
